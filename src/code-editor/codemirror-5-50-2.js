!(function (e, t) {
    ...
    function ee(e) {
        return (
            /\w/.test(e) ||
            (e > "Â€" && (e.toUpperCase() != e.toLowerCase() || J.test(e)))
        );
    }
    function te(e, t) {
    ...
    var ue = (function () {
        ...
        return function (s, u) {
            ...
            for (var f, h = s.length, d = [], p = 0; p < h; ++p)
                d.push(
                    (f = s.charCodeAt(p)) <= 247
                        ? e.charAt(f)
                        : 1424 <= f && f <= 1524
                            ? "R"
                            : 1536 <= f && f <= 1785
            ...
            return (
                ...
                (1 == z[0].level &&
                    (I = s.match(/^\s+/)) &&
                    ((z[0].from = I[0].length), z.unshift(new a(0, 0, I[0].length))),
                    1 == Y(z).level &&
                    (I = s.match(/\s+$/)) &&
                    ((Y(z).to -= I[0].length), z.push(new a(0, h - I[0].length, h)))),
                "rtl" == u ? z.reverse() : z
            );
        };
    })();
    ...
    function Ae(e) {
        if (null == Te) {
            ...
            N(e, A("span", [t, document.createTextNode("x")])),
                ...
                (Te = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && a < 8));
        }
        var r = Te
            ? A("span", "â€‹")
            : A(
    ...
    function Oe(e) {
        ...
        var t = N(e, document.createTextNode("AØ®A")),
    ...
    function dt(e, t, r) {
        ...
        var o = (function (e, t, r) {
            for (
                ...
                if (
                    u &&
                    (!r || a + (u instanceof ut ? u.lookAhead : 0) <= o.modeFrontier)
                )
                    return a;
    ...
    (ct.prototype.lookAhead = function (e) {
        ...
        (ct.fromSaved = function (e, t, r) {
            return t instanceof ut
                ? new ct(e, Ve(e.mode, t.state), r, t.lookAhead)
                : new ct(e, Ve(e.mode, t), r);
        }),
    ...
    function yt(e, t, r, n) {
        ...
        for (n && (o = []); (n || c.pos < t.ch) && !c.eol();)
            (c.start = c.pos),
                (i = vt(a, c, u.state)),
                n && o.push(new mt(c, i, Ve(l.mode, u.state)));
        ...
        for ("" == t && bt(gt(r, n.state), o); !f.eol();) {
            if (
                (f.pos > e.options.maxHighlightLength
                    ? ((a = !1), l && pt(e, t, n, f.pos), (f.pos = t.length), (s = null))
                    : (s = bt(vt(r, f, n.state, h), o)),
                    h)
            ) {
                var d = h[0].name;
                d && (s = "m-" + (s ? d + " " + s : d));
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        if (
                            ...
                            (n || (n = [])).push(
                                new kt(l, a ? null : o.from - t, null == o.to ? null : o.to - t)
                            );
                        }
                    }
                return n;
        ...
        if (s)
            for (var p = 0; p < s.length; ++p) {
                ...
                if ((null != g.to && (g.to += c), null == g.from))
                    St(a, g.marker) || ((g.from = c), u && (a || (a = [])).push(g));
        ...
        if (!u) {
            ...
            if (y > 0 && a)
                for (var b = 0; b < a.length; ++b)
                    null == a[b].to &&
                        (m || (m = [])).push(new kt(a[b].marker, null, null));
    ...
    function Zt(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            (n.pos = 0),
                ...
                (n.map = []),
                rr(o, n, ht(e, o, t != e.display.externalMeasured && qe(o))),
                o.styleClasses &&
                (o.styleClasses.bgClass &&
                    (n.bgClass = E(o.styleClasses.bgClass, n.bgClass || "")),
                    o.styleClasses.textClass &&
                    (n.textClass = E(o.styleClasses.textClass, n.textClass || ""))),
                0 == n.map.length &&
                ...
                for (var d = 0; ;) {
                    ...
                    if ("\t" == p[0]) {
                        var y = e.cm.options.tabSize,
                            b = y - (e.col % y);
                        (m = u.appendChild(A("span", _(b), "cm-tab"))).setAttribute(
                            "role",
                            "presentation"
                        ),
                        ...
                        "\r" == p[0] || "\n" == p[0]
                            ? ((m = u.appendChild(
                                A("span", "\r" == p[0] ? "â" : "â¤", "cm-invalidchar")
    ...
    function er(e, t) {
        return function (r, n, i, o, l, a, s) {
            ...
            for (var u = r.pos, c = u + n.length; ;) {
                ...
                e(r, n.slice(0, f.to - u), i, o, null, a, s),
                    (o = null),
                    (n = n.slice(f.to - u)),
                    (u = f.to);
            }
    ...
    function rr(e, t, r) {
        ...
        if (n)
            for (
                var l, a, s, u, c, f, h, d = i.length, p = 0, g = 1, v = "", m = 0;
                ;
            ...
            for (var A = 1; A < r.length; A += 2)
                t.addToken(t, i.slice(o, (o = r[A])), qt(r[A + 1], t.cm.options));
    }
    function nr(e, t, r) {
        (this.line = t),
            ...
            (this.size = this.rest ? qe(Y(this.rest)) - r + 1 : 1),
    ...
    function gr(e, t, r) {
        ...
        for (
            var n = S("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0;
            i;
            i = o
        )
                                ...
                                if (
                                    (i =
                                        l && a < 9 && 0 == u && c == o.coverEnd - o.coverStart
                                            ...
                                            : Pr(L(s, u, c).getClientRects(), n)).left ||
                                    i.right ||
                                    0 == u
                                )
                                    break;
    ...
    var Hr,
        Er = { left: 0, right: 0, top: 0, bottom: 0 };
    function Fr(e, t, r) {
            ...
            var f = (e.options.lineWrapping
                ? function (e, t, r, n, i, o, l) {
                    ...
                    for (var c = null, f = null, h = 0; h < i.length; h++) {
                        ...
                        if (!(d.from >= u || d.to <= s)) {
                            var p = 1 != d.level,
                                g = Wr(e, n, p ? Math.min(u, d.to) - 1 : Math.max(s, d.from))
                                    .right,
                                v = g < o ? o - g + 1e9 : g - o;
                            (!c || f > v) && ((c = d), (f = v));
                        }
                ...
                : function (e, t, r, n, i, o, l) {
                    var a = le(
                        function (a) {
                            ...
                            return Qr(
                                Xr(
                                    e,
                                    et(r, u ? s.to : s.from, u ? "before" : "after"),
                                    "line",
                                    t,
                                    n
                                ),
                    ...
                    if (a > 0) {
                        var u = 1 != s.level,
                            c = Xr(
                                e,
                                et(r, u ? s.from : s.to, u ? "after" : "before"),
                                "line",
                                t,
                                n
                            );
    ...
    function en(e) {
        ...
        if (null == Hr) {
            ...
            for (var t = 0; t < 49; ++t)
                Hr.appendChild(document.createTextNode("x")), Hr.appendChild(A("br"));
    ...
    function an(e, t, r, n) {
        ...
        if (n && u.xRel > 0 && (s = Xe(e.doc, u.line).text).length == u.ch) {
            ...
            u = et(
                u.line,
                Math.max(0, Math.round((o - Sr(e.display).left) / tn(e.display)) - c)
            );
        }
        return u;
    }
        ...
        for (
            ...
            if (t || l != r.sel.primIndex) {
                ...
                if (
                    ...
                    var s = a.empty();
                    (s || e.options.showCursorWhenSelecting) && vn(e, a.head, i),
                        s || yn(e, a, o);
                }
            }
        return n;
    ...
    function vn(e, t, r) {
        var n = Xr(e, t, "div", null, null, !e.options.singleCursorHeightPerLine),
            i = r.appendChild(A("div", "Â ", "CodeMirror-cursor"));
        if (
            ...
            var o = r.appendChild(
                A("div", "Â ", "CodeMirror-cursor CodeMirror-secondarycursor")
            );
            (o.style.display = ""),
            ...
            if (!i.hidden) {
                if (l && a < 8) {
                    ...
                    (s = f.bottom - f.top),
                        ...
                        i.text.firstChild &&
                        (u =
                            i.text.firstChild.getBoundingClientRect().right - f.left - 1);
                }
                var h = i.line.height - s;
                if ((h > 0.005 || h < -0.005) && (Ye(i.line, s), Ln(i.line), i.rest))
    ...
    function Tn(e, t, r) {
        ...
        if (r && r.ensure) {
            var a = r.ensure.from.line,
                s = r.ensure.to.line;
            a < o
                ? ((o = a), (l = Ze(t, Gt(Xe(t, a)) + e.wrapper.clientHeight)))
                : Math.min(s, t.lastLine()) >= l &&
                ((o = Ze(t, Gt(Xe(t, s)) - e.wrapper.clientHeight)), (l = s));
        }
        ...
        return (
            ...
            t.left < 10
                ...
                : t.left < f
                    ...
                    : t.right > h + f - 3 && (l.scrollLeft = t.right + (d ? 0 : 10) - h),
            l
        );
    }
    function Nn(e, t) {
    ...
    function Dn(e) {
        ...
        t &&
            ((e.curOp.scrollToPos = null),
                Wn(e, $r(e, t.from), $r(e, t.to), t.margin));
    }
    function Wn(e, t, r, n) {
        var i = Mn(e, {
    ...
    function Hn(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 ||
            (r || oi(e, { top: t }), En(e, t, !0), r && oi(e), ei(e, 100));
    }
    function En(e, t, r) {
        (t = Math.max(
            0,
    ...
    function Rn(e, t) {
        ...
        for (
            ...
            r != e.display.barWidth && e.options.lineWrapping && Sn(e),
                Bn(e, Pn(e)),
    ...
    function _n(e) {
        ...
        null != e.adjustWidthTo &&
            ((t.display.sizer.style.minWidth = e.adjustWidthTo + "px"),
                ...
                Fn(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
    ...
    function Yn(e) {
        ...
        (e.updatedDisplay && ii(t, e.update),
            ...
            null != e.scrollTop && En(t, e.scrollTop, e.forceScroll),
            null != e.scrollLeft && Fn(t, e.scrollLeft, !0, !0),
            e.scrollToPos) &&
            (function (e, t) {
        ...
        if (o)
            for (var a = 0; a < o.length; ++a)
                o[a].lines.length && ge(o[a], "unhide");
    ...
    function ei(e, t) {
        e.doc.highlightFrontier < e.display.viewTo &&
            e.state.highlight.set(t, P(ti, e));
    }
    function ti(e) {
        var t = e.doc;
    ...
    function ni(e, t) {
        ...
        !(function (e, t, r) {
            ...
            (r.viewOffset = Gt(Xe(e.doc, r.viewFrom))),
            ...
            (function (e, t, r) {
                ...
                for (var u = n.view, c = n.viewFrom, f = 0; f < u.length; f++) {
                    ...
                    if (h.hidden);
                        ...
                        h.changes &&
                            (B(h.changes, "gutter") > -1 && (d = !1), ur(e, h, c, r)),
                            d &&
                            (M(h.lineNumber),
    ...
    function mi(e, t) {
        ...
        if ((i && u) || (o && c)) {
            ...
            if (i && !r && !f && null != pi)
                return (
                    o && c && Hn(e, Math.max(0, a.scrollTop + o * pi)),
                    Fn(e, Math.max(0, a.scrollLeft + i * pi)),
                    (!o || (o && c)) && we(t),
                        ...
                        setTimeout(function () {
                            if (null != l.wheelStartX) {
                                ...
                                (l.wheelStartX = l.wheelStartY = null),
                                    r && ((pi = (pi * di + r) / (di + 1)), ++di);
                            }
                        }, 200))
                    : ((l.wheelDX += i), (l.wheelDY += o)));
        }
    }
    l ? (pi = -0.53) : r ? (pi = 15) : c ? (pi = -0.7) : h && (pi = -1 / 3);
    var yi = function (e, t) {
    ...
    function Ai(e, t, r, n) {
        ...
        if (t.full)
            ...
            if (1 == u.length)
                ...
                v.push(new Xt(h + c.text.slice(s.ch), d, n)),
    ...
    function Ei(e, t) {
        var r = { from: nt(t.from), to: Ci(t), text: $e(e, t.from, t.to) };
        return (
    ...
    function Ui(e, t, r, n, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
            Yi(e, new yi([Gi(e.sel.primary(), t, r, i)], 0), n);
    }
    function Ki(e, t, r) {
        for (
                ...
                var n = {
                    ...
                    update: function (t) {
                        ...
                        for (var r = 0; r < t.length; r++)
                            this.ranges[r] = new bi(at(e, t[r].anchor), at(e, t[r].head));
                    },
                    origin: r && r.origin,
                };
                return (
    ...
    function Ji(e, t, r, n) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            ...
            (i || s != l.anchor || u != l.head) &&
                (i || (i = t.ranges.slice(0, o)), (i[o] = new bi(s, u)));
        }
        ...
        if (o.markedSpans)
            for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if (
                    ...
                    return (
                        (n < 0 ? u : c) && (d = ro(e, d, n, d.line == t.line ? o : null)),
                        d ? eo(e, d, t, n, i) : null
                    );
                }
            }
    ...
    function lo(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
            ...
            var n = [];
            Oi(e, function (e, r) {
                r || -1 != B(n, e.history) || (po(e.history, t), n.push(e.history)),
                    uo(e, t, null, Tt(e, t));
            });
        }
    }
    function ao(e, t, r) {
        ...
        if (!n || r) {
            for (
                ...
                u = 0;
                u < a.length &&
                ((i = a[u]), r ? !i.ranges || i.equals(e.sel) : i.ranges);
                u++
            );
            if (u != a.length) {
                for (o.lastOrigin = o.lastSelOrigin = null; ;) {
                    ...
                    if ((zi(i, s), r && !i.equals(e.sel)))
                        return void Yi(e, i, { clearRedo: !1 });
                    l = i;
                }
                var c = [];
                zi(l, s),
                ...
                for (
                    ...
                    h = function (r) {
                        ...
                        var o = r ? Si(e, n) : Y(a);
                        uo(e, n, o, ji(e, n)),
                            !r && e.cm && e.cm.scrollIntoView({ from: n.from, to: Ci(n) });
                        var l = [];
                        Oi(e, function (e, t) {
                            t ||
                                -1 != B(l, e.history) ||
                                (po(e.history, n), l.push(e.history)),
                                uo(e, n, null, ji(e, n));
                        });
                    },
            ...
            t.to.line > o &&
                ...
                e.cm
                    ? (function (e, t, r) {
                        ...
                        t.full
                            ? un(e)
                            : o.line != l.line || 1 != t.text.length || Ni(e.doc, t)
                    ...
                    : Ai(e, t, n),
                qi(e, r, G),
                e.cantEdit && to(e, et(e.firstLine(), 0)) && (e.cantEdit = !1);
        }
    }
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var a = 0; a < o.ranges.length; a++)
                    fo(o.ranges[a].anchor, t, r, n), fo(o.ranges[a].head, t, r, n);
            } else {
    ...
    (yo.prototype.clear = function () {
        ...
        (yo.prototype.changed = function () {
            ...
            var i = wr(this) - t;
            i &&
                (jt(this.doc, n) || Ye(n, n.height + i),
                    r &&
                    qn(r, function () {
                        (r.curOp.forceUpdate = !0),
                            bo(r, n, i),
                            ar(r, "lineWidgetChanged", r, e, qe(n));
                    }));
        }),
        be(yo);
    var wo = 0,
        ...
        if (
            (e.iter(s, r.line + 1, function (e) {
                u &&
                    ...
                    zt(e) == u.display.maxLine &&
                    (a = !0),
                    o.collapsed && s != t.line && Ye(e, 0),
                    (function (e, t) {
                        (e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t]),
                            t.marker.attachLine(e);
                    })(
                        e,
                        new kt(o, s == t.line ? t.ch : null, s == r.line ? r.ch : null)
                    ),
                    ++s;
            }),
                o.collapsed &&
            ...
            if ((a && (u.curOp.updateMaxLine = !0), o.collapsed))
    ...
    (xo.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed
                    ? cn(e, qe(l), "text")
                    : e && (null != a.to && (i = qe(l)), null != a.from && (n = qe(l))),
    ...
    function So(e) {
        return e.findMarks(et(e.first, 0), e.clipPos(et(e.lastLine())), function (
            e
        ) {
            return e.parent;
        });
    ...
    var To = 0,
        Mo = function (e, t, r, n, i) {
            ...
            null == r && (r = 0),
                mo.call(this, [new vo([new Xt("", null)])]),
                (this.first = r),
    ...
    (Mo.prototype = Q(mo.prototype, {
        ...
        setSelections: Jn(function (e, t, r) {
            if (e.length) {
                for (var n = [], i = 0; i < e.length; i++)
                    n[i] = new bi(at(this, e[i].anchor), at(this, e[i].head));
                null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
                    Yi(this, wi(this.cm, n, t), r);
            }
        }),
        addSelection: Jn(function (e, t, r) {
            var n = this.sel.ranges.slice(0);
            n.push(new bi(at(this, e), at(this, t || e))),
                Yi(this, wi(this.cm, n, n.length - 1), r);
        }),
        ...
        addLineWidget: Jn(function (e, t, r) {
            return (function (e, t, r, n) {
                ...
                return (
                    ...
                    o && ar(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : qe(t)),
                    i
                );
            })(this, e, t, r);
        }),
                        ...
                        if (f) {
                            ...
                            if (
                                ...
                                for (var d = 0; d < h.length; ++d)
                                    co(t.doc, "", h[d].anchor, h[d].head, "drag");
    ...
    function $o(e, t) {
        ...
        qn(e, function () {
            for (var t = n.length - 1; t >= 0; t--)
                co(e.doc, "", n[t].from, n[t].to, "+delete");
            An(e);
        });
    }
    function _o(e, t, r) {
            ...
            if ((r.input.ensurePolled(), (r.shift = e.shiftKey), xr(r, e)))
                ...
                var n = an(t, e),
                    ...
                    o = n
                        ? (function (e, t) {
                            var r = +new Date();
                            return cl && cl.compare(r, e, t)
                                ? ((ul = cl = null), "triple")
                                : ul && ul.compare(r, e, t)
                                    ? ((cl = new fl(r, e, t)), (ul = null), "double")
                                    : ((ul = new fl(r, e, t)), (cl = null), "single");
                        })(n, i)
                        : "single";
                window.focus(),
                            ...
                            ? (function (e, t, r, n) {
                                ...
                                e.options.dragDrop &&
                                    ...
                                    : (function (e, t, r, n) {
                                        ...
                                        n.addNew && !n.extend
                                            ? ((a = o.sel.contains(r)),
                                                (l = a > -1 ? u[a] : new bi(r, r)))
                                            : ((l = o.sel.primary()), (a = o.sel.primIndex));
                                        if ("rectangle" == n.unit)
                                            n.addNew || (l = new bi(r, r)),
                                                (r = an(e, t, !0, !0)),
                                                (a = -1);
                                        else {
                                            var c = dl(e, r, n.unit);
                                            l = n.extend
                                                ? Gi(l, c.anchor, c.head, n.extend)
                                                : c;
                                        }
                                        n.addNew
                                            ? -1 == a
                                                ? ((a = u.length),
                                                    Yi(o, wi(e, u.concat([l]), a), {
                                                        scroll: !1,
                                                        origin: "*mouse",
                                                    }))
                                                : u.length > 1 &&
                                            ...
                                            if (0 != tt(f, t))
                                                if (((f = t), "rectangle" == n.unit)) {
                                                    for (
                                                        var i = [],
                                                        u = e.options.tabSize,
                                                        c = z(Xe(o, r.line).text, r.ch, u),
                                                        h = z(Xe(o, t.line).text, t.ch, u),
                                                        d = Math.min(c, h),
                                                        p = Math.max(c, h),
                                                        ...
                                                        var m = Xe(o, g).text,
                                                            y = X(m, d, u);
                                                        d == p
                                                            ? i.push(new bi(et(g, y), et(g, y)))
                                                            : m.length > y &&
                                                            i.push(
                                                                new bi(et(g, y), et(g, X(m, p, u)))
                                                            );
                                                    }
                                                    i.length || i.push(new bi(r, r)),
                                                        Yi(
                                                            o,
                                                            wi(e, s.ranges.slice(0, a).concat(i), a),
                                        ...
                                        function g(t) {
                                            (e.state.selectingText = !1),
                                                ...
                                                pe(i.wrapper.ownerDocument, "mouseup", m),
                                        ...
                                        (e.state.selectingText = m),
                                            ...
                                            he(i.wrapper.ownerDocument, "mouseup", m);
                                    })(e, n, t, o);
                            })(t, n, o, e)
                            : Se(e) == r.scroller && we(e)
                        : 2 == i
                            ? (n && Ui(t.doc, n),
                                setTimeout(function () {
    ...
    function pl(e, t, r, n) {
        ...
        for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
            ...
            if (u && u.getBoundingClientRect().right >= i)
                return (
                    ge(e, r, e, Ze(e.doc, o), e.display.gutterSpecs[s].className, t),
                    Ce(t)
                );
        }
    }
    ...
    function Cl(e) {
        e.options.lineWrapping
            ...
            : (T(e.display.wrapper, "CodeMirror-wrap"), Kt(e)),
            ln(e),
            un(e),
            Rr(e),
            setTimeout(function () {
    ...
    function kl(e, t) {
        ...
        for (var c in ((u.wrapper.CodeMirror = this),
            ...
            (function (e) {
                var t = e.display;
                he(t.scroller, "mousedown", Zn(e, hl)),
                    he(
                        t.scroller,
                        "dblclick",
                        l && a < 11
                            ...
                            (l =
                                !n.prev || o(n, n.prev)
                                    ...
                                    : !n.prev.prev || o(n, n.prev.prev)
                                        ? e.findWordAt(a)
                                        : new bi(et(a.line, 0), at(e.doc, et(a.line + 1, 0)))),
                ...
                he(s, "keyup", function (t) {
                    ...
                    he(s, "keydown", Zn(e, ll)),
                    he(s, "keypress", Zn(e, sl)),
                    he(s, "focus", function (t) {
                        return Cn(e, t);
                    }),
            ...
            (t.autofocus && !m) || this.hasFocus()
                ? setTimeout(P(Cn, this), 20)
                : kn(this),
            wl))
            wl.hasOwnProperty(c) && wl[c](this, t[c], yl);
    ...
    function Ll(e, t, r, n) {
        ...
        if (n || /\S/.test(a.text)) {
            if (
                "smart" == r &&
                ((u = o.mode.indent(i, a.text.slice(c.length), a.text)) == V || u > 150)
            ) {
                if (!n) return;
                r = "prev";
            }
        ...
        "prev" == r
            ? (u = t > o.first ? z(Xe(o, t - 1).text, null, l) : 0)
            : "add" == r
        ...
        if ((h < u && (f += _(u - h)), f != c))
            return (
                co(o, f, et(t, 0), et(t, c.length), "+input"), (a.stateAfter = null), !0
            );
        ...
        if (a && n.ranges.length > 1)
            if (Tl && Tl.text.join("\n") == t) {
                if (n.ranges.length % Tl.text.length == 0) {
                    u = [];
                    for (var c = 0; c < Tl.text.length; c++)
                        u.push(o.splitLines(Tl.text[c]));
                }
            } else
            ...
            d.empty() &&
                (r && r > 0
                    ...
                    : e.state.overwrite && !a
                        ? (g = et(
                            g.line,
                            Math.min(Xe(o, g.line).text.length, g.ch + Y(s).length)
                        ))
                        : a &&
                        Tl &&
                        Tl.lineWise &&
        ...
        function u(n) {
            ...
            if (
                ...
                (o = i
                    ? (function (e, t, r, n) {
                        ...
                        if ("rtl" == e.doc.direction || 1 == l.level) {
                            ...
                            if (
                                null != h &&
                                (f ? h <= l.to && h <= c.end : h >= l.from && h >= c.begin)
                            ) {
                ...
                if (
                    ...
                    (l = t.line + s) < e.first ||
                    l >= e.first + e.size ||
                    ((t = new et(l, t.ch, t.sticky)), !(a = Xe(e, l)))
                )
                    return !1;
    ...
    (Pl.prototype.init = function (e) {
        ...
        function l(e) {
            if (o(e) && !ve(n, e)) {
                if (n.somethingSelected())
                    Ml({ lineWise: !1, text: n.getSelections() }),
                        "cut" == e.type && n.replaceSelection("", null, "cut");
                else {
                    if (!n.options.lineWiseCopyCut) return;
                    var t = Dl(n);
                    Ml({ lineWise: !0, text: t.text }),
                        "cut" == e.type &&
                        n.operation(function () {
                            n.setSelections(t.ranges, 0, G),
        ...
        (Pl.prototype.pollContent = function () {
            ...
            if (
                (0 == l.ch &&
                    ...
                    a.ch == Xe(n.doc, a.line).text.length &&
                    a.line < n.lastLine() &&
                    (a = et(a.line + 1, 0)),
                    l.line < i.viewFrom || a.line > i.viewTo - 1)
            )
                return !1;
            l.line == i.viewFrom || 0 == (e = sn(n, l.line))
            ...
            for (
                ...
                h = $e(n.doc, et(t, 0), et(s, Xe(n.doc, s).text.length));
            ...
            return f.length > 1 || f[0] || tt(x, C)
                ? (co(n.doc, f, x, C, "+input"), !0)
                : void 0;
        }),
        ...
        (Pl.prototype.needsContentAttribute = !0);
    var jl = function (e) {
        (this.cm = e),
            (this.prevInput = ""),
            (this.pollingFast = !1),
    ...
    (jl.prototype.init = function (e) {
        ...
        function o(e) {
            if (!ve(n, e)) {
                if (n.somethingSelected())
                    ...
                    Ml({ lineWise: !0, text: t.text }),
                        "cut" == e.type
                            ? n.setSelections(t.ranges, null, G)
        ...
        (jl.prototype.poll = function () {
            ...
            if (
                (l && a >= 9 && this.hasSelection === i) ||
                (y && /[\uf700-\uf7ff]/.test(i))
            )
                return t.display.input.reset(), !1;
            if (t.doc.sel == t.display.selForContextMenu) {
                var o = i.charCodeAt(0);
                if ((8203 != o || n || (n = "â€‹"), 8666 == o))
            ...
            function m() {
                if (
                    ...
                    ((t.contextMenuPending = !1),
                        ...
                        (i.style.cssText = h),
                        l && a < 9 && n.scrollbars.setScrollTop((n.scroller.scrollTop = u)),
                ...
                r("lineSeparator", null, function (e, t) {
                    if (((e.doc.lineSep = t), t)) {
                        ...
                        for (var i = r.length - 1; i >= 0; i--)
                            co(e.doc, t, r[i], et(r[i].line, r[i].ch + t.length));
                    }
                }),
                r(
                    "specialChars",
        ...
        (function (e) {
            ...
            (e.prototype = {
                    ...
                    for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                        ...
                        if (i.empty())
                            ...
                            0 == o.ch &&
                                t.length == u.length &&
                                u[n].from().ch > 0 &&
                                Xi(this.doc, n, new bi(o, u[n].to()), G);
                        }
                    }
                }),
                ...
                heightAtLine: function (e, t, r) {
                    ...
                    return (
                        Gr(this, n, { top: 0, left: 0 }, t || "page", r || i).top +
                        (i ? this.doc.height - Gt(n) : 0)
                    );
                },
                ...
                addWidget: function (e, t, r, n, i) {
                    ...
                    (t.style.top = u + "px"),
                        ...
                        ((o = this),
                            ...
                            null != (a = Mn(o, l)).scrollTop && Hn(o, a.scrollTop),
                            null != a.scrollLeft && Fn(o, a.scrollLeft));
                },
                ...
                findPosH: function (e, t, r, n) {
                    ...
                    for (
                        ...
                        l < t && !(o = El(this.doc, o, i, r, n)).hitSide;
                        ++l
                    );
                    return o;
                },
                moveH: Qn(function (e, t) {
                    ...
                    this.extendSelectionsBy(function (n) {
                        return r.display.shift || r.doc.extend || n.empty()
                            ? El(r.doc, n.head, e, t, r.options.rtlMoveVisually)
                            : e < 0
                                ? n.from()
                                : n.to();
                    }, K);
                ...
                setSize: Qn(function (e, t) {
                    ...
                    null != e && (this.display.wrapper.style.width = n(e)),
                        ...
                        this.options.lineWrapping && zr(this);
    ...
    for (var Gl in Mo.prototype)
        Mo.prototype.hasOwnProperty(Gl) &&
            B(Vl, Gl) < 0 &&
            (kl.prototype[Gl] = (function (e) {
                return function () {
    ...
    return (
        be(Mo),
        (kl.inputStyles = { textarea: jl, contenteditable: Pl }),
        ...
        kl.defineMIME("text/plain", "null"),
        (kl.defineExtension = function (e, t) {
            kl.prototype[e] = t;
        }),
    ...
    (function (e) {
        ...
        e.defineMode("javascript", function (t, r) {
                        ...
                        (t.tokenize =
                            ((r = n),
                                function (e, t) {
                                    var n,
                                        i = !1;
                                    if (a && "@" == e.peek() && e.match(d))
                                        return (t.tokenize = g), p("jsonld-keyword", "meta");
                                        ...
                                        : ";" == e
                                            ...
                                            : "if" == e
                                                ? ("else" == k.state.lexical.info &&
                                                    k.state.cc[k.state.cc.length - 1] == P &&
                                                    k.state.cc.pop()(),
                                                    L(F("form"), V, z, P, Le))
                                                : "function" == e
                                                    ? L(Ae)
                                                    : "for" == e
                                                        ...
                                                        : "class" == e || (u && "interface" == t)
                                                            ? ((k.marked = "keyword"), L(F("form", "class" == e ? e : t), Ee, P))
                                                            : "variable" == e
                                                                ? u && "declare" == t
                                                                    ? ((k.marked = "keyword"), L(z))
                                                                    : u &&
                                                                        ...
                                                                        ? ((k.marked = "keyword"),
                                                                            "enum" == t
                                                                                ? L(Xe)
                                                                                : "type" == t
                                                                                    ? L(De, I("operator"), fe, I(";"))
                                                                                    : L(F("form"), we, I("{"), F("}"), le, P, P))
                                                                        : u && "namespace" == t
                                                                            ? ((k.marked = "keyword"), L(F("form"), B, z, P))
                                                                            : u && "abstract" == t
                                                                                ? ((k.marked = "keyword"), L(z))
                                                                                : L(F("stat"), J)
                                                                : "switch" == e
                                                                    ? L(F("form"), V, I("{"), F("}", "switch"), H, le, P, P, E)
                                                                    : "case" == e
                                                                        ? L(B, I(":"))
                                                                        : "default" == e
                                                                            ? L(I(":"))
            ...
            function G(e, t, r) {
                ...
                return w.hasOwnProperty(e)
                    ...
                    : "function" == e
                        ? L(Ae, i)
                        : "class" == e || (u && "interface" == t)
                            ? ((k.marked = "keyword"), L(F("form"), He, P))
                            : "keyword c" == e || "async" == e
                                ? L(r ? j : B)
                                : "(" == e
                                    ? L(F(")"), U, I(")"), P, i)
            ...
            function _(e) {
                if ("}" == e)
                    return (k.marked = "string-2"), (k.state.tokenize = m), L($);
            }
            function Y(e) {
            ...
            function te(e, t) {
                ...
                if ("variable" == e || "keyword" == k.style) {
                    ...
                    if ("number" == e || "string" == e)
                        return (k.marked = a ? "property" : k.style + " property"), L(ne);
            ...
            function ue(e) {
                if (u && ":" == e)
                    return k.stream.match(/^\s*\w+\s+is\b/, !1) ? L(B, ce, fe) : L(fe);
            }
            function ce(e, t) {
            ...
            function fe(e, t) {
                return "keyof" == t || "typeof" == t || "infer" == t
                    ? ((k.marked = "keyword"), L("typeof" == t ? j : fe))
                    : "variable" == e || "void" == t
                        ? ((k.marked = "type"), L(ge))
                        : "|" == t || "&" == t
                            ? L(fe)
            ...
            function de(e, t) {
                return "variable" == e || "keyword" == k.style
                    ? ((k.marked = "property"), L(de))
                    : "?" == t || "number" == e || "string" == e
                        ? L(de)
                        : ":" == e
                            ? L(fe)
                            : "[" == e
                                ? L(I("variable"), se, I("]"), de)
                                : "(" == e
                                    ? S(Oe, de)
                                    : void 0;
            }
            ...
            function be(e, t) {
                return "enum" == t
                    ? ((k.marked = "keyword"), L(Xe))
                    : S(we, ae, ke, Se);
            }
            function we(e, t) {
                return u && N(t)
                    ? ((k.marked = "keyword"), L(we))
                    : "variable" == e
                        ? (M(t), L())
                        : "spread" == e
                            ? L(we)
            ...
            function Ne(e, t) {
                return ")" == e
                    ...
                    : ";" == e
                        ? L(Ne)
                        : "in" == t || "of" == t
                            ? ((k.marked = "keyword"), L(B, Ne))
                            : S(B, Ne);
            }
            function Ae(e, t) {
                return "*" == t
                    ? ((k.marked = "keyword"), L(Ae))
                    : "variable" == e
                        ? (M(t), L(Ae))
                        : "(" == e
                            ? L(W, F(")"), ie(We, ")"), P, ue, z, E)
                            : u && "<" == t
                                ? L(F(">"), ie(me, ">"), P, Ae)
                                : void 0;
            }
            ...
            function Fe(e, t) {
                return "<" == t
                    ...
                    : "extends" == t || "implements" == t || (u && "," == e)
                        ? ("implements" == t && (k.marked = "keyword"), L(u ? fe : B, Fe))
                        : "{" == e
                            ? L(F("}"), Pe, P)
                            : void 0;
            }
            function Pe(e, t) {
                return "async" == e ||
                    ...
                    ? ((k.marked = "keyword"), L(Pe))
                    : "variable" == e || "keyword" == k.style
                        ? ((k.marked = "property"), L(Ie, Pe))
                        : "number" == e || "string" == e
                            ? L(Ie, Pe)
                            : "[" == e
                                ? L(B, ae, I("]"), Ie, Pe)
            ...
            function ze(e, t) {
                return "*" == t
                    ? ((k.marked = "keyword"), L(Ue, I(";")))
                    : "default" == t
                        ? ((k.marked = "keyword"), L(B, I(";")))
                        : "{" == e
                            ? L(ie(Re, "}"), Ue, I(";"))
                            : S(z);
            }

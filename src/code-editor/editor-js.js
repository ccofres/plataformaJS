        ...
        1: [
            function (t, e, n) {
                !(function () {
                    ...
                    var e,
                        n,
                        r = t("./editor-libs/feature-detector.js"),
                            ...
                            "complete" === t.target.readyState &&
                                setTimeout(function () {
                                    o.trackloadEventEnd(
                                        ...
                                        a.postToKuma({ markName: "js-ie-load-event-end" }),
                                        e.refresh();
                                }, 200);
                        });
                })();
                ...
                e.exports = {
                        ...
                        new Clipboard(".copy", {
                            target: function (t) {
                                ...
                                return e
                                    ...
                                    : r.findParentChoiceElem(t).getElementsByTagName("code")[0];
                            },
                    ...
                    toggleClippy: function (t) {
                        ...
                        for (
                            ...
                            n = document.querySelectorAll(".copy"),
                            r = 0,
                            i = n.length;
                            r < i;
                            r++
                            ...
                            n[r].classList.add("hidden"),
                                n[r].setAttribute("aria-hidden", !0);
                ...
                e.exports = {
                    ...
                    choose: function (t) {
                        ...
                        t.classList.add("selected"),
                            ...
                            e.exports.applyCode(n.textContent, t);
                    },
                    resetDefault: function () {
                        ...
                        if (t.classList.contains("hidden")) {
                            for (
                                var r = n.querySelectorAll("section"), i = 0, o = r.length;
                                i < o;
                                i++
                            )
                                r[i].classList.add("hidden"),
                                    r[i].setAttribute("aria-hidden", !0);
                ...
                e.exports = {
                    onChoose: function (t) {
                        ...
                        if (e && !t.classList.contains("selected")) {
                            var n = Prism.highlight(
                                e.firstChild.textContent,
                                Prism.languages.css
                            );
                            (e.firstChild.innerHTML = n),
                                o.trackCSSExampleSelection(),
                                i.resetDefault();
                        }
                                ...
                                window.addEventListener(
                                    ...
                                    function (t) {
                                        if (void 0 !== t.data.smallViewport) {
                                            ...
                                            t.data.smallViewport
                                                ? e.classList.add("small-desktop-and-below")
                                                : e.classList.remove("small-desktop-and-below");
                                        }
                                    },
                                    !1
                                );
                                ...
                                (function (t) {
                                    t.addEventListener("cut", s),
                                        ...
                                        t.addEventListener("click", function (t) {
                                            var n = t.target;
                                            n.classList.contains("example-choice") ||
                                                (n = a.findParentChoiceElem(n)),
            ...
            function (t, e, n) {
                e.exports = {
                    findParentChoiceElem: function (t) {
                        "use strict";
                        for (
                            var e = t.parentElement, n = e.classList;
                            e && !n.contains("example-choice");
